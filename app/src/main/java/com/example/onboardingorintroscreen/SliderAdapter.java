...
public class SliderAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        TextView titleView = view.findViewById(R.id.heading);
        TextView desView = view.findViewById(R.id.description);

        imageView.setImageResource(imageArray[position]);
        titleView.setText(titleArray[position]);
        desView.setText(descriptionArray[position]);
